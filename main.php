...
if (isset($_SESSION["logged_in"]) && $_SESSION["logged_in"] != true) {
    ...
    if (mysqli_num_rows($result) > 0) {
        while ($rr = mysqli_fetch_assoc($result)) {
            ...
            if (strtolower($rr["extension"]) == 'pdf') {
                $files_table .= "<a class=\"iframe\" href=\"javascript:viewPdf('//{$_SERVER['SERVER_NAME']}{$script_dir}{$rr["path"]}');\" title=\"Preview\"><span class=\"glyphicon glyphicon-zoom-in\"></span></a>&nbsp;";
            }
    ...
    <div id="content-main">
        <?php if ($level == "admin") {
            ...
            <table border="0" cellspacing="0" cellpadding="0" class="homeTable logTable">
                <tr id="tblHeader">
