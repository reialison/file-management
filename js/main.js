...
$(document).ready(function(){
	...
	$('.arrowRightQuote').on('click',function(){
		countImagesQuote=$('.sliderQuote > ul li').length-1;
	...
	$('#subContact').on('click',function(e){
		e.preventDefault();
		var error='';
	...
	$('#subRegister').on('click',function(e){
		e.preventDefault();
		var error='';
...
$(function(e) {
	...
	$('.arrowLeftSlider').on('click',function (){
	...
	$('.arrowRightSlider').on('click',function (){
			clearInterval(galleryInterval);	
			galleryInterval=null;							  
			ImagesRight();			
	});
